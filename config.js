...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~ONY1hZDS#Iin3pIjXYDNO3Y-rLRum0p9BmlQlQBVgWEjU5mGQLWU",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "+251 97 678 6441",
    OWNER_NAME: process.env.OWNER_NAME || "qooqjabiye",
